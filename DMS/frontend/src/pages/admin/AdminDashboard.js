    ...
    <div style={{ padding: isMobile ? '0' : '0' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {[
            { label: 'Thêm khách hàng', icon: '➕', path: '/Anminh/admin/customers?action=add' },
            { label: 'Tạo lộ trình', icon: '🗺️', path: '/Anminh/admin/routes?action=add' },
            { label: 'Xem bản đồ', icon: '📍', path: '/Anminh/admin/map' },
            { label: 'Xuất báo cáo', icon: '📊', path: '/Anminh/admin/reports' }
          ].map((action, index) => (
            <button
              key={index}
