            ...
            <section id="features" className="py-20 bg-[#020617]">
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-24">
                        ...
                        <div className="relative h-[500px] bg-gradient-to-br from-cyan-500/10 to-blue-500/10 rounded-2xl border border-white/10 p-8 flex items-center justify-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                        <div className="relative h-[400px] bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-2xl border border-white/10 p-8 flex items-center justify-center order-2 md:order-1 overflow-hidden">
