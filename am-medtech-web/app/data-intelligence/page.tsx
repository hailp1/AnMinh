        ...
        <main className="min-h-screen bg-[#020617] text-white overflow-x-hidden font-sans">
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 bg-[#020617]/90 backdrop-blur-md border-b border-white/5 transition-all duration-300">
                <div className="container mx-auto px-6 py-4 flex justify-between items-center">
                    ...
                    <div className="hidden md:flex items-center gap-8">
                        ...
                        <Link href="/data-intelligence" className="text-cyan-400 text-sm font-medium transition-colors">Data Intelligence</Link>
            ...
            <section className="py-20 bg-slate-900/30 border-y border-white/5">
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="relative h-[400px] bg-[#0B1221] rounded-3xl border border-white/10 overflow-hidden shadow-2xl">
            ...
            <section className="py-20">
                <div className="container mx-auto px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-2 bg-slate-800/30 rounded-3xl border border-white/5 p-8">
            ...
            <section className="py-24 bg-gradient-to-b from-slate-900 to-[#020617]">
                <div className="container mx-auto px-6">
                    ...
                    <div className="relative max-w-5xl mx-auto h-[400px] bg-[#0B1221] rounded-3xl border border-purple-500/20 p-8 overflow-hidden shadow-[0_0_50px_rgba(168,85,247,0.1)]">
                        {/* Grid Lines */}
            ...
            <section className="py-24 text-center">
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto bg-gradient-to-r from-cyan-900/20 to-blue-900/20 border border-cyan-500/20 rounded-3xl p-12 backdrop-blur-sm">
